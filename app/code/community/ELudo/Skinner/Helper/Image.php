 ...
 */
class ELudo_Skinner_Helper_Image extends Mage_Core_Helper_Abstract
{
    /**
    ...
    /**
     * Return the base media directory for Skin Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Skin Item images
     *
     * @return string
     */
    ...
    public function uploadImage($scope)
    {
        ...
        if ($adapter->isUploaded($scope)) {
            ...
            if (!$adapter->isValid($scope)) {
                Mage::throwException(Mage::helper('eludo_skinner')->__('Uploaded image is not valid'));
            }
    ...
    /**
     * Return URL for resized Skin Item Image
     *
     * @param ELudo_Skinner_Model_Skin $item
     * @param integer $width
     * @param integer $height
     * @return bool|string
     */
    public function resize(ELudo_Skinner_Model_Skin $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
