 ...
 */
class ELudo_Skinner_Block_Adminhtml_Skinner_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
    ...
    public function __construct()
    {
        ...
        if (Mage::helper('eludo_skinner/admin')->isActionAllowed('save')) {
            $this->_updateButton('save', 'label', Mage::helper('eludo_skinner')->__('Save Skin Item'));
        ...
        if (Mage::helper('eludo_skinner/admin')->isActionAllowed('delete')) {
            $this->_updateButton('delete', 'label', Mage::helper('eludo_skinner')->__('Delete Skin Item'));
        } else {
    ...
    {
        return $this->getUrl('*/*/skin_delete', array($this->_objectId => $this->getRequest()->getParam($this->_objectId)));
    }
